...
PARTS = [
    ("Bottom Plate", "CNC"),
    ("Top Plate", "CNC"),
    ("Cooling Tubes Block 2ml", "CNC"),
    ("Cooling Tubes Block 15ml", "CNC"),
    ("2 Holder", "CNC"),
    ("8 Holder", "CNC"),
    ("Magnets", "MECH"),
    ...
    ("Cooler Bottom 2 ml", "3DPRT"),
    ("Cooler Bottom 15 ml", "3DPRT"),
    ("Cooler Top 2 ml", "3DPRT"),
    ("Cooler Top 15 ml", "3DPRT"),
    ("Cooler 2 ml Screw Cover", "3DPRT"),
    ("Frog Holder", "3DPRT"),
...
BOM_DEFAULTS = [
    ...
    ("Cooling Tubes Block 2ml", "MO:COOL 2ml", 1),
    ("Cooling Tubes Block 15ml", "MO:COOL 15m", 1),
    ("2 Holder", "Tube Holder 8T2", 1),
    ("8 Holder", "Tube Holder 8T2", 1),
    ("Tube Holder Trash", "Tube Holder 8T2", 1),
    ("8 Holder", "Tube Holder 888", 3),
    ("2 Holder", "Tube Holder 222", 3),
    ("Spring Plungers 5 mm", "MO:HEAT", 3),
    ("Thermal Mat Adhesive", "MO:HEAT", 1),
    ("Thermal Mat 1mm", "MO:COOL 2ml", 1),
    ("Thermal Mat 1mm", "MO:COOL 15m", 1),
    ("Thermal Paste", "MO:COOL 2ml", 1),
    ("Thermal Paste", "MO:COOL 15m", 1),
    ("Temperature Sensor", "MO:HEAT", 1),
    ("Temperature Sensor", "MO:COOL 2ml", 1),
    ("Temperature Sensor", "MO:COOL 15m", 1),
    ("Heating Mat", "MO:HEAT", 1),
    ("Fan Big", "MO:COOL 2ml", 1),
    ("Fan Small", "MO:COOL 2ml", 1),
    ("Peltier 12V", "MO:COOL 2ml", 1),
    ("Peltier 24V", "MO:COOL 15m", 1),
    ...
    ("Cooler Bottom 2 ml", "MO:COOL 2ml", 1),
    ("Cooler Bottom 15 ml", "MO:COOL 15m", 1),
    ("Cooler Top 2 ml", "MO:COOL 2ml", 1),
    ("Cooler Top 15 ml", "MO:COOL 15m", 1),
    ("Cooler 2 ml Screw Cover", "MO:COOL 2ml", 2),
]
